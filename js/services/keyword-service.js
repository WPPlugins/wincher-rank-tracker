...
angular.module('app').service('keywordService', ['$http', '$upload', '$q', '$filter', function ($http, $upload, $q, $filter) {
    ...
    var addGroupToKeywordBulk = function (accountDomainKeywordIds, name) {
        ...
        var params = {
            _ajax_nonce: my_ajax_obj.nonce,
            action: "angular_proxy",
            type: "keywordgroup_add_bulk",
            accountDomainKeywordIds: accountDomainKeywordIds,
            name: name
        };
    ...
    return {
        ...
        addGroupToKeywordBulk : addGroupToKeywordBulk,
